        ...
        <div className="animate-fade-in-left">
          ...
          <button
            ...
            className='mt-10 px-10 py-3 rounded-xl
              ...
              hover:-translate-y-2 hover:scale-105 active:scale-95 transition-all duration-300 ease-out'>
            <FcGoogle size={22} />
  ...
  return (
    <div
      className='relative rounded-2xl p-6
        ...
        text-white hover:-translate-y-3 hover:scale-105 transition-all duration-300 ease-out'
